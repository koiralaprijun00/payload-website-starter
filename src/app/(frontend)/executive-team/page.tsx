      ...
      <div className="text-mainBlue py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl">
            <h1 className="text-4xl md:text-5xl font-bold mb-6 text-left">Executive Team</h1>
            <p className="text-xl md:text-2xl text-mainBlue-100 leading-relaxed text-left">
              Meet our executive leadership team driving organizational strategy and vision
            </p>
          </div>
        </div>
      </div>
            ...
            <div className="mb-16">
              <div className="mb-12">
                ...
                <p className="text-gray-600 max-w-2xl">
                  Past executive team members who have contributed to our mission
                </p>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
            ...
            <div className="text-center py-16">
              <div className="max-w-md mx-auto">
                <h3 className="text-2xl font-semibold text-gray-900 mb-4">
                  No Executive Team Members or Alumni Found
                </h3>
                <p className="text-gray-600">
                  Executive team member and alumni profiles will appear here once they are added to
                  the system.
                </p>
              </div>
            </div>
