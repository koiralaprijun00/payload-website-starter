  ...
  return (
    <section className="py-16 -mt-28 relative z-10">
      <div className="container mx-auto">
        <div className="grid md:grid-cols-[6fr_4fr] gap-0 max-w-5xl mx-auto shadow-lg">
          ...
          <div className="bg-lime-200 border-16 border-orange-500 p-4 flex flex-col justify-between">
